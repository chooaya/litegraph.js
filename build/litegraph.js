...
*/
	var node_types = LiteGraph.getNodeTypesInCategory( "features", canvas.filter );
	var values = [];
	...
	new LiteGraph.ContextMenu( values, {event: e, callback: inner_create, parentMenu: prev_menu }, ref_window);
	/*
...
LGraphCanvas.prototype.getCanvasMenuOptions = function()
{
	...
	{
		options = [
			{ content:"ノード追加", has_submenu: true, callback: LGraphCanvas.onMenuAdd }
...
if(this && this.CanvasRenderingContext2D)
...
function ContextMenu( values, options )
{
	...
	if(options.event)
	{
		root_document = options.event.target.getRootNode();
		//root_document = options.event.target.parentElement;
	}
		

	if(!root_document)
		root_document = document;
	if (root_document === document)
	{
...
/*
	root.style.left = 40 + "px";
	root.style.top = 700  + "px";
	*/
}
...
if(typeof(exports) != "undefined"){
	exports.LiteGraph = global.LiteGraph;
}
...
//basic nodes
(function(global){
var LiteGraph = (global || exports).LiteGraph;
